...
class EquipAddViewTestGET(TestCase):
    ...
    def setUp(self):
        ...
        self.url_add = reverse('mechatronics:equip-add')
...
class EquipSeachViewTestPostSearchFounded(TestCase):
    ...
    def setUp(self):
        ...
        self.url_search = reverse('mechatronics:equip-search')
...
class EquipSeachViewTestPostEdit(TestCase):
    ...
    def test_edit_get_search_by_id(self):
        ...
        url_edit = reverse('mechatronics:equip-edit', args=(id_1,))
...
class EquipSeachViewTestPostDelete(TestCase):
    ...
    def setUp(self):
        ...
        self.url_delete = reverse('mechatronics:equip-delete')
